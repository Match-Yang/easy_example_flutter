...
4. Get your AppID, ServerURL(If you need to build for web) and temporary token from ZEGOCLOUD Console [My Projects -> project's Edit -> Basic Configurations] : https://console.zegocloud.com/project for both User1 and User2.
...
Copy `zego_express_manager.dart` file and `platform_impl` folder to [your_project > lib] folder.

#### For web

Copy `[exay_example_flutter > web > js]` folder to your project at the same place.

Add this line of code `<script src="./js/ZegoExpressManager.js"></script>` to the index.html inside head tag.

```html
  <title>easy_example_flutter</title>
  <link rel="manifest" href="manifest.json">
  <script src="./js/ZegoExpressManager.js"></script> <!--Add this line-->
</head>
<body>
```
